    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4 md:p-6 max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-6">
            <h1 className="text-2xl font-bold text-black border-l-4 border-blue-600 pl-3 mb-8">Профиль</h1>
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    <Input
                      ...
                      className={`h-12 ${errors.name ? "border-red-500" : "border-gray-300"} rounded-lg ${errors.name ? "pr-10" : ""}`}
                      readOnly={!isEditing}
                    />
                    {errors.name && (
